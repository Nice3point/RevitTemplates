...
![image](https://github.com/user-attachments/assets/a42cff3c-e8f0-4e27-9e96-23f35a751fa4)
...
1. Select the desired [template](Templates), such as Revit Addin for a single-project add-in.
...
2. **Debug.R25** compiles the solution for Revit 2025. The last two digits indicate the Revit [version](Managing-API-compatibility).
...
To add another project to your solution, we will [use](Templates) the **Revit AddIn Module** and **Revit AddIn Application** templates.

### Create a New Project

1. Select the [template](Templates), in this case, **Revit AddIn Application**, which has fewer settings and files than `Revit AddIn`.
...
1. Choose the **Revit AddIn Module** [template](Templates).
...
1. Select the solution [template](Templates), in this case **Revit Addin Solution**.
...
For the more advanced, or developers who want more control over releases, go to the [publishing](Publishing-the-Release) page.
